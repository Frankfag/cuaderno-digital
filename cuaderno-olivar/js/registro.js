...
// =========================================================
// BORRAR PESAJE INDIVIDUAL
// =========================================================

window.borrarPesaje = function (id) {

  const confirmar = confirm(
    "¿Quieres borrar este pesaje?"
  );
...
// =========================================================
// RESETEAR CAMPAÑA ACTIVA
// =========================================================

function resetearPesajesCampaña() {

  const confirmar = confirm(
    "¿Eliminar todos los pesajes de la campaña activa?"
  );

  if (!confirmar) return;

  const campaña = getCampañaActiva();

  const datos = getRegistros().filter(item => {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  document
    .getElementById("btnResetRegistro")
    ?.addEventListener("click", resetearPesajesCampaña);
